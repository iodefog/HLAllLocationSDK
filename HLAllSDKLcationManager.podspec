#
#  Be sure to run `pod spec lint HLAllSDKLcationManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/lihongli528628/HLAllLocationSDK.git", :tag => "1.0" }
  ...
  s.source_files  = "HLAllSDKLcationManager/**"
